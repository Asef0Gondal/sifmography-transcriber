...
from transcribe_app import normalize_timestamp, resolve_local_model_path, is_valid_timestamp

class TestTranscriberApp(unittest.TestCase):
    
    def test_is_valid_timestamp(self):
        self.assertTrue(is_valid_timestamp(""))
        self.assertTrue(is_valid_timestamp("90"))
        self.assertTrue(is_valid_timestamp("120.5"))
        self.assertTrue(is_valid_timestamp("01:30"))
        self.assertTrue(is_valid_timestamp("02:15:30"))
        self.assertFalse(is_valid_timestamp("abc"))
        self.assertFalse(is_valid_timestamp("1:2:3:4"))
        self.assertFalse(is_valid_timestamp("12:abc"))
